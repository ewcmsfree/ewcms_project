...
<html>
	<head>
		...
		$(function(){
			...
			ewcmsBOBJ.setQueryURL('<s:url namespace="/particular/ea" action="query"/>');
			...
			ewcmsOOBJ.setInputURL('<s:url namespace="/particular/ea" action="input"/>');
			ewcmsOOBJ.setDeleteURL('<s:url namespace="/particular/ea" action="delete"/>');
		});
		</script>		
	</head>
