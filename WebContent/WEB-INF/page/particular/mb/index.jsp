...
<html>
	<head>
		...
		$(function(){
			...
			ewcmsBOBJ.setQueryURL('<s:url namespace="/particular/mb" action="query"/>');
			...
			ewcmsOOBJ.setInputURL('<s:url namespace="/particular/mb" action="input"/>');
			ewcmsOOBJ.setDeleteURL('<s:url namespace="/particular/mb" action="delete"/>');
		});
		</script>		
	</head>
