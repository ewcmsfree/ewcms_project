...
<html>
	<head>
		...
		$(function(){
			...
			ewcmsBOBJ.setQueryURL('<s:url namespace="/particular/pa" action="query"/>');
			...
			ewcmsOOBJ.setInputURL('<s:url namespace="/particular/pa" action="input"/>');
			ewcmsOOBJ.setDeleteURL('<s:url namespace="/particular/pa" action="delete"/>');
		});
		</script>		
	</head>
