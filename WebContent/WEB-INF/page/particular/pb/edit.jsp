		...
		<s:form action="save" namespace="/particular/pb">
			<table class="formtable" >
				...
				<tr>
					<td>投资规模：</td>
					<td colspan="2">
						<s:textfield id="investmentScale" cssClass="inputtext" name="projectBasicVo.investmentScale" size="30"/>
					</td>
					<td>项目概况：</td>
					<td colspan="2">
						<s:textfield id="overview" cssClass="inputtext" name="projectBasicVo.overview" size="60"/>
					</td>
				</tr>
				<tr>
					...
					<td width="23%" class="formFieldError">
						<s:select list="@com.ewcms.content.particular.model.ProjectBasic$Nature@values()" listValue="description" name="projectBasicVo.bildNature" id="projectBasicVo_bildNature" headerKey="" headerValue="----请选择----"></s:select>
				...
				<tr>
					...
					<td class="formFieldError">
						<ewcms:datepicker id="buildTime" name="projectBasicVo.buildTime" option="inputsimple" format="yyyy-MM-dd"/>
				...
				<tr>
					...
					<td>形式：<span style="color:#FF0000">*</span></td>
					<td>
			...
			<s:hidden name="projectBasicVo.code"/>
