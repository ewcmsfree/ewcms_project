...
<html>
	<head>
		...
		$(function(){
			...
			ewcmsBOBJ.setQueryURL('<s:url namespace="/particular/ma" action="query"/>');
			...
			ewcmsOOBJ.setInputURL('<s:url namespace="/particular/ma" action="input"/>');
			ewcmsOOBJ.setDeleteURL('<s:url namespace="/particular/ma" action="delete"/>');
		});
		</script>		
	</head>
