...
<html>
	<head>
		...
		$(function(){
			...
			ewcmsBOBJ.setQueryURL('<s:url namespace="/particular/eb" action="query"/>');
			...
			ewcmsOOBJ.setInputURL('<s:url namespace="/particular/eb" action="input"/>');
			ewcmsOOBJ.setDeleteURL('<s:url namespace="/particular/eb" action="delete"/>');
		});
		</script>		
	</head>
