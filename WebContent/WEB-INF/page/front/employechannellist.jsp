                                        ...
                                        <table width="95%"  border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td height="30" bgcolor="#F2F2F2" class="li_line"><div align="center" class="hui">
                                                        ...
                                                        <s:else>
                                                            <s:url action="employechannellist" id="pageUrl" escapeAmp="false">
...
function jumpPage(obj){
    ...
    window.location = ' <s:url action="employechannellist"/>?channelId=<s:property value="channelVO.id"/>&pageNumber=' + page ;
}
  function $(id){
